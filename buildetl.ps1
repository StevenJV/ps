...
Write-Host "Schema.exe --SourceDb=cm_insightsqalocal1 --SourceServer=. --RunStaging --StagingServer=. --StagingDb=Insights_Staging --AdminServer=. --AdminDb=Insights_Admin" -ForegroundColor green
Navex.Insights.Etl.Schema\bin\Release\Navex.Insights.Etl.Schema.exe --SourceDb=cm_insightsqalocal1 --SourceServer=. --RunStaging --StagingServer=. --StagingDb=Insights_Staging --AdminServer=. --AdminDb=Insights_Admin
